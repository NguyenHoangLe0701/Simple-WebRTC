...
const SessionAnalyticsIndividual = () => {
  ...
  const loadAllData = async () => {
    try {
      ...
      const [summaryData, ipsData, devicesData] = await Promise.all([
        sessionAnalyticsService.getSessionSummary(),
        sessionAnalyticsService.getTopIPs(),
        sessionAnalyticsService.getTopDevices()
      ]);
    ...
    <div className="p-6">
      ...
      {summary && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <SummaryCard
            title="Force Logout"
            value={summary.forceLogoutSessions}
            color="bg-red-500"
          />
        </div>
      )}
...
// Summary Card Component (same as above)
...
export default SessionAnalyticsIndividual;